...
enum TemplateReplaceWindowWidgets {
	...
	TRW_WIDGET_TMPL_BUTTONS_REFIT_TEMPLATE,
	...
	NWidget(NWID_VERTICAL),
		...
		NWidget(NWID_VERTICAL),
			...
			NWidget(NWID_HORIZONTAL),
				...
				NWidget(WWT_PUSHTXTBTN, COLOUR_GREY, TRW_WIDGET_TMPL_BUTTONS_REFIT_TEMPLATE), SetMinimalSize(140,12), SetResize(1,0), SetFill(1,0), SetDataTip(STR_TEMPLATE_REFIT_BUTTON, STR_TEMPLATE_REFIT_BUTTON),
